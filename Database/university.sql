...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2023 at 09:18 PM
...
INSERT INTO `admission_form` (`formid`, `first_name`, `middle_name`, `last_name`, `father_name`, `email`, `mobileno`, `course_code`, `session`, `current_address`, `permanent_address`, `gender`, `dob`, `profile_image`, `signature`, `thumb`) VALUES
(1, 'Anup Kumar', '', 'Paswan', 'Yogendra Prasad', 'cpcbelgharia56@gmail.com', '09123771458', 'B.Fashion', '2023-2024', '3/17 Jatindas Nagar', 'Belgharia', 'Male', '1989-12-15', 'Screenshot (155).png', 'Screenshot (173).png', 'Screenshot (160).png');
...
(6, 'teacher@gmail.com', '12345', 'Teacher', 'Activate'),
(7, 'partha@gmail.com', 'teacher123*', 'Teacher', ''),
(8, 'student@gmail.com', 'student123*', 'Student', 'Activate');
...
(1, '2023-2024', '2023-05-16 16:25:40');
...
(7, 'BBA', 1, '1001', 'PF', '', '15-05-23'),
(8, 'BBA', 1, '1001', 'PF', '', '15-05-23');
...
(3, '12345', 25000, '2023-05-16 16:19:48', 'Paid');
...
('12345', 'Sayandip', '', 'Paul', 'Rathin Paul', 'sayandip@gmail.com', '8521479630', 'MCS', 'S19', 'salsa.jpg', 'Select Opt', 'Select Opt', '', 'Admitted', 'Approved', '', '', '', 'Select Gen', '', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, '', '2023-05-16 16:16:12');
...
CREATE TABLE `teacher_info` (
  ...
  `teacher_status` varchar(10) DEFAULT NULL,
  ...
  `matric_complition_date` varchar(10) DEFAULT NULL,
  `matric_awarded_date` varchar(10) DEFAULT NULL,
  `matric_certificate` varchar(100) DEFAULT NULL,
  `fa_complition_date` varchar(10) DEFAULT NULL,
  `fa_awarded_date` varchar(10) DEFAULT NULL,
  `fa_certificate` varchar(100) DEFAULT NULL,
  `ba_complition_date` varchar(10) DEFAULT NULL,
  `ba_awarded_date` varchar(10) DEFAULT NULL,
  `ba_certificate` varchar(100) DEFAULT NULL,
  `ma_complition_date` varchar(10) DEFAULT NULL,
  `ma_awarded_date` varchar(100) DEFAULT NULL,
  `ma_certificate` varchar(101) DEFAULT NULL,
  `last_qualification` varchar(20) DEFAULT NULL,
...
(2, 'Anup', 'Kumar', 'Paswan', '', 'akanup67@gmail.com', '9123771458', 0x696d616765732e706e67, 'Permanent', 'Yes', '8793', '1987-01-17', '0', 'Male', 'abc', 'def', 'ghij', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '18-06-21'),
(3, 'Poonam', 'K', 'Kumari', NULL, 'poonam@gmail.com', '8981887239', 0x74776f2e6a7067, 'Permanent', 'Yes', '12345', '1989-05-16', '', 'Female', 'Ranchi', 'Kolkata', 'Ranchi', '2023-05-17', '2023-05-03', 'Screenshot (155).png', '2023-05-19', '2023-05-21', 'Screenshot (157).png', '2023-05-30', '2023-05-29', 'Screenshot (163).png', '', '', '', NULL, NULL, '16-05-23'),
(4, 'Partha', '', 'Koley', NULL, 'partha@gmail.com', '7412589630', 0x737570726979615f696d672e6a7067, 'Contract', 'Yes', '', '1990-05-24', '', 'Male', 'Kolkata', 'Kolkata', '', '', '', '', '', '', '', '', '', '', '', '', '', NULL, NULL, '16-05-23');
...
--
ALTER TABLE `student_courses`
  MODIFY `student_course_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `student_fee`
--
ALTER TABLE `student_fee`
  MODIFY `fee_voucher` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
