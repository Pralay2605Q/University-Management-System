...
<html lang="en">
	<head>
		<title>Login - Sur Tech</title>
	</head>
	<body class="login-background" url="../Images/sur1.jpeg">
		<?php include('../common/common-header.php') ?>
        <div class="login-div mt-3 rounded">
            <div class="logo-div text-center">
                <img src="../Images/surtech.png" alt="" class="align-items-center" width="100" height="100">
            </div>
