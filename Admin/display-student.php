...
<html lang="en">
	...
	while ($row=mysqli_fetch_array($run)) {
		?>
		<div class="container  mt-1 border border-secondary mb-1" style="padding-left: 1%;width:60%">
			<div class="row text-white bg-primary pt-5">
				<div class="col-md-4">
					<?php  $profile_image= $row["profile_image"] ?>
					<img class="ml-5 mb-5 mt-5" height='190px' width='150px' src=<?php echo "images/$profile_image"  ?> >
				</div>
				<div class="col-md-8">
