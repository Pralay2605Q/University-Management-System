								...
								<div class="col-md-6">
									<div class="form-group">
										<div class="d-flex">
											...
											<input type="submit" name="submit" class="btn btn-primary px-4 ml-5" value="Search Student">
										</div>
									</div>
								</div>
									...
									if (isset($_POST['submit'])) {
										...
										?>
											...
											<tr>
												...
												<td><input type="submit" name="sub" value="Submit Fees" class="btn btn-primary px-4 ml-4"></td>
											</tr>
